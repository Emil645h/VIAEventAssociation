...
public class EventConfigurations : IEntityTypeConfiguration<Event>
{
    public void Configure(EntityTypeBuilder<Event> builder)
    {
        ...
        builder.ComplexProperty<EventVisibility>("visibility", visibilityBuilder =>
        {
            visibilityBuilder.Ignore("_value");
            visibilityBuilder
                .Property("_displayName")
                .HasColumnName("Visibility");
        });
        
        builder.ComplexProperty<EventStatus>("status", statusBuilder =>
        {
