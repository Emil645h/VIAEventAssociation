...
using VIAEventAssociation.Core.Domain.Common.UnitOfWork;using VIAEventAssociation.Core.Domain.Contracts;
using VIAEventAssociation.Core.Tools.OperationResult.OperationResult;


public class GuestParticipationHandler : ICommandHandler<GuestParticipationCommand>
{
    ...
    internal GuestParticipationHandler(
    ...
    public async Task<Result> HandleAsync(GuestParticipationCommand command)
    {
        ...
        var assignResult = @event.AssignGuestToGuestList(guest, currentTime);
