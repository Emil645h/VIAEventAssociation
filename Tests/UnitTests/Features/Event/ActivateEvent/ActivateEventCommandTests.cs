...
public class ActivateEventCommandTests
{
    ...
    public void Create_WithValidId_ReturnsSuccessResult()
    {
        ...
        // Act
        var result = ActivateEventCommand.Create(validId);
    ...
    public void Create_WithInvalidGuidFormat_ReturnsError()
    {
        ...
        // Act
        var result = ActivateEventCommand.Create(invalidId);
        var resultFailure = Assert.IsType<Failure<ActivateEventCommand>>(result);
